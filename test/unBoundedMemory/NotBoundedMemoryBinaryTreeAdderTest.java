...
public class NotBoundedMemoryBinaryTreeAdderTest {

	private NotBoundedMemoryBinaryTreeAdderTester sbadder;
	
	private BinaryTreeVisitUtility btutility;
	...
	public void setUp() throws Exception {
		...
		this.btutility=new BinaryTreeVisitUtility();

		this.sbadder=new NotBoundedMemoryBinaryTreeAdderTester();
	...
	public void testAdderOnBalancedTreeH1() {
		...
		assertEquals(1,this.sbadder.getCountOfVisitedNodes());
	...
	public void testAdderOnBalancedTreeH5() {
		...
		assertEquals(31,this.sbadder.getCountOfVisitedNodes());
	...
	public void testAdderOnBalancedTreeH10() {
		...
		assertEquals(1023,this.sbadder.getCountOfVisitedNodes());
	...
	public void testAdderOnUnbalancedTreeLH5() {
		...
		assertEquals(5,this.sbadder.getCountOfVisitedNodes());
	...
	public void testAdderOnRandomTreeRH5() {
		...
		assertEquals(btutility.getNumberofNodes(rootRandomH5),this.sbadder.getCountOfVisitedNodes());
